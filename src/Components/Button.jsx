function button({contactBy, children}) {
    return (
      <div className='col-span-1 items-center justify-start flex text-white'>
        ...
        rounded-full w-full hover:bg-white/5 transition-all duration-300 shadow-lg shadow-white/5 
        active:scale-105 active:duration-75 text-white/70 hover:text-white bg-black/80`}>
          {children}

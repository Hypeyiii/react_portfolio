const Project = ({projectName, children, projectDescription, viewButtons, projectImg}) => { 
  return (
    ...
    <div className={`text-black/90 dark:text-white/90 mt-5 grid grid-cols-12 auto-rows-auto w-full gap-x-4 gap-y-4 items-start justify-center mb-10`}>
      <div className="col-span-12 md:col-span-6 w-full h-full border border-white/5 hover:border-white/50 transition-all duration-300 rounded-lg
        overflow-hidden aspect-video cursor-pointer relative group [&>img]:hover:blur-[1.5px]">
            <div
                ...
                to-transparent bg-gradient-to-t inset-x-0 -bottom-2 text-white flex items-end">
                <div>
                    <div

const Project = ({projectName, techTitleClass, techDescriptionClass, children, projectDescription, ViewButtons, projectImg}) => { 
  return (
    <>
    <div className="grid grid-cols-12 auto-rows-auto w-full mb-10 gap-x-4 gap-y-4 items-start justify-center">

...
function Introduction ({ nameText, hireText, introductionText, companyButtonClass, onOpen, modalOpen, avatar}) {
  ...
  return (
    <div id='inicio' className='mt-32 flex w-[350px] sm:w-[500px] md:w-[700px] lg:w-[850px] mx-auto flex-col px-2'>
        <div className='group/item relative flex cursor-pointer size-[100px] md:size-[125px] rounded-full shadow-2xl shadow-white/10
        ...
        <div className='mt-5 flex flex-row gap-x-5 md:gap-x-8 items-center justify-start'>
          <h1 className={`font-bold text-2xl md:text-3xl lg:text-5xl text-black dark:text-white`}>
            {nameText}
          </h1>

...
const AboutMeModal = ({ onClose, aboutMeText , presentationText, aboutMeClass}) => {
    return (
      ...
      px-2 flex justify-center items-center`}>
        <div className="fixed inset-0 dark:opacity-90 dark:bg-gradient-to-tr dark:from-black dark:via-white dark:to-black opacity-95 
              bg-gradient-to-br from-slate-600 via-black to-slate-600" onClick={onClose}></div>
